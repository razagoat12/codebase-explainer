    ...
    return (
      <div className="bg-black">
        ...
        <footer className="border-t border-neutral-900 bg-black px-6 py-8">
          <div className="mx-auto flex max-w-5xl flex-col items-center justify-between gap-3 text-xs text-neutral-500 sm:flex-row">
            <span>© {new Date().getFullYear()} Codebase Explainer</span>
            <div className="flex items-center gap-5">
              <Link to="/privacy" className="transition hover:text-neutral-300">
                Privacy Policy
              </Link>
              <Link to="/docs" className="transition hover:text-neutral-300">
                Docs
              </Link>
              <Link to="/pricing" className="transition hover:text-neutral-300">
                Pricing
              </Link>
            </div>
          </div>
